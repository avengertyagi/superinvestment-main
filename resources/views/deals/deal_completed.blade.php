    ...
    <div class="container mx-auto">
        <div class="w-11/12 md:px-24 my-8 mx-auto">
            <ul class="flex items-center my-4 border-b-2 border-gray-500 mb-14">
                <li class="cursor-pointer py-0 px-4 text-2xl font-basic text-gray-800"><a href="{{ route('deals')}}">Active</a></li>
                <div class="border-t-4 border-orangemix">
                    <div class="border-b-2 border-white -mb-1 bg-white md:flex">
                        <li class="cursor-pointer py-0 px-4 text-2xl font-basic border-l-2 border-r-2 border-gray-500 text-gray-800 "><a href="{{ route('deals.complete')}}">Completed</a></li>
                    </div>
                </div>
            </ul>

            <x-deals.completedeal :deals="$deals"></x-deals.completedeal>
        </div>
        <script>
            new Splide( '.saprate' ,  {
                type   : 'loop',
