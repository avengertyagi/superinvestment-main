        ...
        <div class="py-8">
            ...
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="flex flex-row mb-1 sm:mb-0">
                    <h1 class="font-semibold">Payments<i class="fa fa-download m-2"></i></h1>
                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        <tr>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <a href="{{ route('admin.payments.view', $payment) }}"> {{ $payment->payment_id }} </a></td>
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                      {{ $payment->asset_id }}  </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">
                                    {{ $payment->asset->user->name }} </p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                <p class="text-gray-900 whitespace-no-wrap">
                                    {{ $payment->asset->deal->name }}
                                </p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                ₹ {{ $payment->amount / 100 }}
