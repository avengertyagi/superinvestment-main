...
<div class="w-max" x-show="openTab == 4">


    <form class="financials"
          name="financials"
          x-data="financials()"
          x-init="initQuill()"
    ...
    <!-- Invest section -->
        ...
        <div class="py-6 px-4 sm:p-6 lg:pb-8">
            <div>
                <h2 class="text-lg leading-6 font-medium text-gray-900">Financials</h2>
                <p class="mt-1 text-sm text-gray-500">
                    Please enter Financials.
                </p>
            </div>


            <div class="bg-white max-w-2xl mt-2" >
                <div id="financials-toolbar" class="toolbar">
    ...
    <script>
        ...
        function financials(){
            return {
                ...
                initQuill() {
                    quillF = new Quill(this.$refs.financials, {
                        theme: 'snow',
                        modules: {
                            toolbar: { container: '#financials-toolbar' }
                        },
                    });
                },
                submit() {
                    ...
                    axios.post('{{ route('admin.dealDetails.update') }}', {
                        //_token: '{{ csrf_token() }}',
                        financial: quillF.root.innerHTML,
